...
2. 郵便番号・電話番号: 
   - 数字とハイフンは【半角】が正解です。半角で表記されている場合は指摘しないでください。
3. 所在地（住所・ビル名）: 
   - 住所内の数字やハイフンは【全角】が正解です。半角が混在している場合は指摘してください。
4. 診療時間・休診日: ページ内の記述がマスターデータと矛盾していないか。
5. 経歴の整合性: ページ内にスタッフや院長の経歴がある場合、西暦や内容に矛盾がないか。
6. Descriptionの妥当性: ページ内容を適切に反映しているか。
